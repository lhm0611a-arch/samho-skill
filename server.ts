...
[중요 원칙]: 
1. 꼬리 질문은 본 질문의 정답이나 힌트를 알려주거나 정답을 확인하는 형태가 되어서는 안 되며, 지원자의 생각이나 대처를 묻는 독립적인 후속 질문이어야 합니다.
2. 피면접자(외국인 근로자 지원자) 대상이므로 과도하게 정중하거나 어려운 표현(예: '말씀해 주시겠습니까', '~생각인가요', '~취할 건가요')은 피하고, 쉽고 직관적인 구어체('~할 거예요?', '~어떻게 해요?', '~있어요?')로 질문해 주세요.
질문 앞에는 "[신규]" 라는 말머리를 꼭 붙여주세요.

예시:
[신규] 오늘 아침에 몇 시에 일어났어요? → 일어나서 제일 먼저 무엇을 했어요?
[신규] 고향에서 가장 유명한 곳은 어디예요? → 보통 누구와 함께 가요?
[신규] 작업장에 불이 나면 어떻게 할 거예요? → 동료들에게 위험하다고 어떻게 알릴 거예요?
[신규] 회사에 지각할 것 같으면 어떻게 할 거예요? → 출근 몇 분 전까지 미리 연락할 거예요?
[신규] 용접 작업을 할 때 가장 중요하게 생각하는 것은 뭐예요? → 품질을 좋게 하려면 어떻게 해야 할까요?
