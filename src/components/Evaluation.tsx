            ...
            <div className="flex items-center justify-between gap-1.5 sm:gap-2 w-full">
              ...
              <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
                <select
                  ...
                  className="bg-[#0a1b35] text-[10px] sm:text-[11px] font-semibold text-blue-300 border border-blue-500/30 rounded-lg px-1.5 py-0.5 sm:py-1 outline-none cursor-pointer hover:border-blue-400 transition-colors shrink min-w-0 truncate max-w-[105px] sm:max-w-[135px] h-7"
                  title="AI 면접관 음성 선택"
                >
                  <option value="InJoon">👨 한국인 남성 1 (인준 - 표준음)</option>
                  <option value="Hyunsu">👨 한국인 남성 2 (현수 - 중저음)</option>
                </select>
